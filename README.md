...
--------------------------------
- A mac with OSX El Capitan or later. Don't fret if you don't have a mac! You can run OSX on your Windows PC using Virtual Box. Or if you're a tinkerer like me you can dual boot using Hackintosh.
